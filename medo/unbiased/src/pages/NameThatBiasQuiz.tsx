...
12
13export default function NameThatBiasQuiz() {
...
31          .select('*')
32          .eq('quiz_type', 'name_that_bias');
33
...
162          <h1 className="text-3xl font-bold mb-2">{t('bias_detector.name_that_bias', language)}</h1>
